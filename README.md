...
Coverage (`.github/workflows/coverage.yml`) publishes JaCoCo to GitHub Pages on PR.
...
**Manual trigger** (independent of PR): `.github/workflows/integration.yml` via `workflow_dispatch`
